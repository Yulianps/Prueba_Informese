...
exceldf = pd.read_excel('C:\\Users\\WilsonYulianPinzónSi\\Documents\\Informese\\PruebaYP\\inputs\\ejercicio1_b1.xlsx', usecols = 'A:D')
...
#Leemos archico texto plano ejercicio_b3.txt 

textdf = pd.read_table('C:\\Users\\WilsonYulianPinzónSi\\Documents\\Informese\\PruebaYP\\inputs\\ejercicio1_b2.txt',header= 0)
...
outputdf.to_csv('C:\\Users\\WilsonYulianPinzónSi\\Documents\\Informese\\PruebaYP\\outputs\\outputdf.csv', sep="|", index=False, quoting=csv.QUOTE_NONE, escapechar=" ")
